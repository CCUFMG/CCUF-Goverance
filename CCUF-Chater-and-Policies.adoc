...
.. Voting will take place by email or other online tool as specified by the CCUG MG. The specific details for voting will be announced at the same time as the call for vote by the CCUF MG.
.. In order for a ballot to count it must include the entity name and the name of the person casting the vote (but voter’s name will not be tracked along with the actual vote, only that their entity has voted and the person’s contact information).
